...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Website", "https://www.commingsoon.com")
    buttons.buildbutton("Owner", "https://t.me/dastan0007")
...
'''
        ...
        sendMarkup('Fuck Off!!!🖕🖕🖕🖕🖕', context.bot, update.message, reply_markup)
